...
function ActivityFeed() {
  const activities = [
    ...
    },
    {
      ...
      description: "Payment of $1,250 received from Sarah",
      time: "12 minutes ago",
        ...
        <div className="space-y-4">
          ...
          {activities.map((activity) => {
            return (
              <div
                key={activity.id}
                className="flex items-center space-x-4 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
              >
