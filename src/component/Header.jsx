      ...
      <div className="flex items-center justify-between bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 px-6 py-4">
        ...
        <div className="flex items-center">
          ...
          <div className="hidden md:block ml-3">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Welcome back, Anusha! Here's what's happening today
            </p>
          </div>
        ...
        <div className="flex-1 max-w-md mx-8">
          ...
          <div className="relative">
            ...
            <button className="absolute right-2 top-1/2 transform -translate-y-1/2 p-1.5 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200">
